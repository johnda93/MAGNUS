...
define('C_FULL_PATH', 'C:/xampp/htdocs/MAGNUS/'); //full path

define('C_L_GLOBAL', 'http://localhost/MAGNUS/'); //application global link
...
define('C_DB_DATABASE_NAME', 'magnus'); //DB database name
