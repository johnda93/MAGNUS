<?php /* Smarty version Smarty-3.0.9, created on 2015-11-03 19:40:47
         compiled from "C:/xampp/htdocs/MAGNUS/templates\footer.tpl" */ ?>
<?php /*%%SmartyHeaderCode:242135638ffaf25f478-23252531%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '242135638ffaf25f478-23252531',
  'function' => 
  array (
  ),
	...
	<div class="container">
		<div class="row">
			...
			<div class="col l4 offset-l2 s12">
				...
				<ul>
					<li><a class="grey-text text-lighten-3" href="http://167.114.135.150/moodle/course/view.php?id=12721">Moodle DCPS</a></li>
					<li><a class="grey-text text-lighten-3" href="http://frameworkg.com/files/versions/glight.rar">Glight Package</a></li>
...
js/jquery.form.min.js" language="Javascript"></script>
	<script src="<?php echo $_smarty_tpl->getVariable('gvar')->value['l_global'];?>
js/js.cookie.js" language="Javascript"></script>
	<script src="<?php echo $_smarty_tpl->getVariable('gvar')->value['l_global'];?>
js/admin.js" language="Javascript"></script>
