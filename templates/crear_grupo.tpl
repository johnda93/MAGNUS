<div class="white container secundario z-depth-1">
	...
	<div class="row botones-inferiores">
		<div class="col s6">
			<div class="container">
			<a class="waves-effect waves-light green lighten-1 btn boton-crear-grupo" href="#modal-guardar-grupo-asig">
		...
		<div class="col s6">
			<div class="container">
				<a class="waves-effect waves-light green lighten-1 btn boton-crear-grupo" href="#modal-cancelar-grupo-asig">
	...
	<div id="modal-guardar-grupo-asig" class="modal">
		<div class="modal-content">
			<h5>Guardar Grupo</h5>
			<p>¿Está seguro que desea guardar este grupo?</p>
		</div>
		<div class="modal-footer">
			<a class="modal-action modal-close waves-effect waves-green btn-flat" href="#!">No</a>
			<a id="conf-guardar-grupo-asig" class="modal-action modal-close waves-effect waves-green btn-flat">Sí</a>
		</div>
	</div>

	<div id="modal-cancelar-grupo-asig" class="modal">
		<div class="modal-content">
			<h5>Cancelar Grupo</h5>
			<p>¿Está seguro que desea cancelar la creación del grupo y guardar la asignatura sin éste?</p>
		</div>
		<div class="modal-footer">
			<a class="modal-action modal-close waves-effect waves-green btn-flat" href="#!">No</a>
			<a id="conf-cancelar-grupo-asig" class="modal-action modal-close waves-effect waves-green btn-flat">Sí</a>
		</div>
	</div>
</div>